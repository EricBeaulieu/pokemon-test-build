...
public class Mago : HoldItemBase
{
    public override BerryID BerryId { get { return BerryID.Mago; } }
    public override HoldItemBase ReturnDerivedClassAsNew() { return new Mago(); }
